    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fayda_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('user_type', models.CharField(choices=[('farmer', 'Farmer'), ('merchant', 'Merchant'), ('admin', 'Admin')], default='farmer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('farm_size_unit', models.CharField(blank=True, max_length=20, null=True)),
